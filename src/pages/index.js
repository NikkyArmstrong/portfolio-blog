...
export default function Index({location}) {
  ...
  return (
    <Layout>
      ...
      <p>I am currently a freelance Lead Programmer, currently working with at <OutboundLink href="https://www.perfectgarbagestudios.com/" target="_blank" rel="noreferrer">Perfect Garbage</OutboundLink>, and on my own projects under my own banner Shuffle Thump.</p>
