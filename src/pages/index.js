...
export default function Index({location}) {
  ...
  return (
    <Layout>
      ...
      <p>I am currently Lead Programmer at <OutboundLink href="https://silverraingames.com" target="_blank" rel="noreferrer">Silver Rain Games</OutboundLink> where as well as writing tools & gameplay code, I make sure the code team is ticking along happily.</p>
